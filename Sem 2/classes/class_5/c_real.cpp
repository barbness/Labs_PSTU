...
Complex::Complex() : Pair(), real_part(0), image_part(0) {}

Complex::Complex(int r, int i) : Pair(r, i), real_part(r), image_part(i) {}

Complex::Complex(const Complex& other)
    : Pair(other), real_part(other.real_part), image_part(other.image_part) {}
...
Pair* Complex::operator+(const Pair& other) const {
    return new Complex(this->firstGet() + other.firstGet(),
                       this->secondGet() + other.secondGet());
}
